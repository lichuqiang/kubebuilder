...
var _ = Describe("main workflow", func() {
	It("should perform main kubebuilder workflow successfully", func() {
		...
		kubebuilderTest := framework.NewKubebuilderTest(c.workDir, framework.TestContext.BinariesDir)
...
func cleanup(builderTest *framework.KubebuilderTest, workDir string, imageName string) {
