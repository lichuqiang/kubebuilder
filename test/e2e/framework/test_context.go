...
const (
	...
	defaultKubectlPath = "/usr/local/kubebuilder/bin/kubectl"
	defaultKubebuilderPath = "/usr/local/kubebuilder/bin/kubebuilder"
)
...
type TestContextType struct {
	...
	CertDir            string
	Host               string
	// kubebuilder related items
	KubebuilderPath string
	ProjectDir      string
}
...
func RegisterFlags() {
	...
	flag.StringVar(&TestContext.KubectlPath, "kubectl-path", defaultKubectlPath, "The kubectl binary to use.")
	...
	flag.StringVar(&TestContext.KubebuilderPath, "kubebuilder-path", defaultKubebuilderPath, "The kubebuilder binary to use.")
